...
public class Operator extends JFrame implements ActionListener {
   ...
   Operator() {
      ...
      final ImageIcon i = new ImageIcon("criminal1.jpg");
      ...
      /*
       * b9.setForeground(new Color(255,255,255)); b9.setFont(new
       * Font("Arial",Font.BOLD,15)); b9.setBackground(new Color(0,64,64));
       * 
       * b10.setForeground(new Color(255,255,255)); b10.setFont(new
       * Font("Arial",Font.BOLD,15)); b10.setBackground(new Color(0,64,64));
       */
   ...
   public void actionPerformed(final ActionEvent ae) {
      if (ae.getSource() == b5) {
         final Insert1 d = new Insert1();
         d.setSize(700, 600);
         d.setVisible(true);
      }
      if (ae.getSource() == b3) {
         System.out.println("Face Framing page opening");
         final faceIdMain1 f1 = new faceIdMain1();
         f1.setSize(800, 800);
         f1.setVisible(true);
      ...
      if (ae.getSource() == b9) {
         final MatchingImg mi = new MatchingImg();
         mi.setSize(700, 600);
         mi.setVisible(true);
      ...
      if (ae.getSource() == b10) {
         final DatafromOp da = new DatafromOp();
         da.setSize(600, 400);
         da.setVisible(true);
